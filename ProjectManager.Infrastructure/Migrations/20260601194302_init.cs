    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceParams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceParams_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "F1E2D3C4-B5A6-7890-1234-56789ABCDEF0", "C1D2E3F4-5678-90AB-CDEF-1234567890AB", "Telemetria", "TELEMETRIA" }
                });
            ...
            migrationBuilder.InsertData(
                table: "WorkScopeTemplates",
                columns: new[] { "Id", "Description", "Order", "ProjectType", "WorkScopeType" },
                values: new object[] { 15, "Wentylacja", 8, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 73, "Napięcie generatora L3-1", "UL31G", 73, 1 },
                    ...
                    { 78, "Prąd generatora L2", "IL2G", 78, 1 },
                    ...
                    { 90, "Zadany współczynnik mocy z SCADA", "PFSCADA", 90, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 124, "Energia", "Energia", 4, 2 },
                    { 125, "Rezerwa", "Rezerwa", 5, 2 },
                    { 126, "Rezerwa", "Rezerwa", 6, 2 },
                    { 127, "Rezerwa", "Rezerwa", 7, 2 },
                    { 128, "Rezerwa", "Rezerwa", 8, 2 },
                    { 129, "Rezerwa", "Rezerwa", 9, 2 },
                    { 130, "Rezerwa", "Rezerwa", 10, 2 },
                    { 131, "Temperatura", "Temperatura", 1, 3 },
                    { 132, "Licznik Gazu Ciśnienie P1", "Licznik", 2, 3 },
                    { 133, "Ciśnienie Pb", "Pb", 3, 3 },
                    { 134, "Przepływ Qm", "Qm", 4, 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 135, "Przepływ Qb", "Qb", 5, 3 },
                    { 136, "Licznik Vm", "Licznik Vm", 6, 3 },
                    { 137, "Licznik Vb", "Licznik Vb", 7, 3 },
                    { 138, "Licznik energii", "Licznik energii", 8, 3 },
                    { 139, "Rezerwa", "Rezerwa", 9, 3 },
                    { 140, "Powietrze zasysane B", "Rezerwa", 10, 3 },
                    { 141, "Napięcie UL1", "UL1", 1, 4 },
                    { 142, "Napięcie UL2", "UL2", 2, 4 },
                    { 143, "Napięcie UL3", "UL3", 3, 4 },
                    { 144, "Napięcie UL12", "UL12", 4, 4 },
                    { 145, "Napięcie UL23", "UL23", 5, 4 },
                    { 146, "Napięcie UL31", "UL31", 6, 4 },
                    { 147, "Prąd IL1", "IL1", 7, 4 },
                    { 148, "Prąd IL2", "IL2", 8, 4 },
                    { 149, "Prąd IL3", "IL3", 9, 4 },
                    { 150, "Częstotliwość", "F", 10, 4 },
                    { 151, "Moc czynna", "P", 11, 4 },
                    { 152, "Moc bierna", "Q", 12, 4 },
                    { 153, "Moc pozorna", "S", 13, 4 },
                    { 154, "Współczynnik mocy", "PF", 14, 4 },
                    { 155, "Energia czynna", "Ep", 15, 4 },
                    { 156, "Energia bierna", "Eq", 15, 4 },
                    { 157, "Energia pozorna", "Es", 17, 4 },
                    { 158, "Rezerwa", "Rezerwa", 18, 4 },
                    { 159, "Rezerwa", "Rezerwa", 19, 4 },
                    { 160, "Rezerwa", "Rezerwa", 20, 4 },
                    { 161, "Rezerwa", "Rezerwa", 1, 5 },
                    { 162, "Rezerwa", "Rezerwa", 2, 5 },
                    { 163, "Rezerwa", "Rezerwa", 3, 5 },
                    { 164, "Rezerwa", "Rezerwa", 4, 5 },
                    { 165, "Rezerwa", "Rezerwa", 5, 5 },
                    { 166, "Rezerwa", "Rezerwa", 6, 5 },
                    { 167, "Rezerwa", "Rezerwa", 7, 5 },
                    { 168, "Rezerwa", "Rezerwa", 8, 5 },
                    { 169, "Rezerwa", "Rezerwa", 9, 5 },
                    { 170, "Powietrze zasysane B", "Rezerwa", 10, 5 }
                });
