...
namespace ProjectManager.Infrastructure.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DivisionPositions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DivisionPositionType = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    PerformedData = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CompletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DivisionPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DivisionPositions_Divisions_DivisionId",
                        column: x => x.DivisionId,
                        principalTable: "Divisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DivisionPositions_SubContractors_SubContractorId",
                        column: x => x.SubContractorId,
                        principalTable: "SubContractors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarginGen = table.Column<float>(type: "real", nullable: false),
                    MarginInstall = table.Column<float>(type: "real", nullable: false),
                    Discount = table.Column<float>(type: "real", nullable: false),
                    Maturity = table.Column<int>(type: "int", nullable: false),
                    CompanyCost = table.Column<float>(type: "real", nullable: false),
                    CompanyGuarantee = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_SubContractors_VendorId",
                        column: x => x.VendorId,
                        principalTable: "SubContractors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PositionPosts_DivisionPositions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "DivisionPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Agregat", 1, 0 },
                    { 2, "Prace budowlano-konstrukcyjne", 2, 0 },
                    { 3, "Układ chłodzenia i wyprowadzenia ciepła", 3, 0 },
                    { 4, "Wentylacja", 4, 0 },
                    { 5, "Instalacje elektryczne", 5, 0 },
                    { 6, "Instalacja gazowa", 6, 0 },
                    { 7, "Zarządzenie projektem, dokumenetacja techniczna, rozruchy", 7, 0 },
                    { 8, "Zespół prądotwórczy", 1, 1 },
                    { 9, "Zespół prądotwórczy - Logistyka", 2, 1 },
                    { 10, "Instalacje elektryczne", 3, 1 },
                    { 11, "Układ chłodzenia silnika", 4, 1 },
                    { 12, "Układ odprowadzenia spalin", 5, 1 },
                    { 13, "Instalacja paliwowa", 6, 1 },
                    { 14, "Instalacja olejowa", 7, 1 },
                    { 15, "Wentylacja", 8, 1 },
                    { 16, "Prace budowlano-konstrukcyjne", 9, 1 },
                    { 17, "Zarządzenie projektem, dokumenetacja techniczna, rozruchy", 10, 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DivisionPositions_DivisionId",
                table: "DivisionPositions",
                column: "DivisionId");

            migrationBuilder.CreateIndex(
                name: "IX_DivisionPositions_SubContractorId",
                table: "DivisionPositions",
